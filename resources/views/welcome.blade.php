        ...
        <div class="relative overflow-hidden">
            ...
            <header class="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6 lg:px-10">
                ...
                <div class="flex items-center gap-3">
                    <a href="https://ktauchathuranga.gumroad.com/l/sponsor" target="_blank" rel="noopener noreferrer" class="group hidden items-center justify-center gap-1.5 rounded-lg border border-pink-300/80 px-4 py-2 text-sm font-medium text-zinc-700 transition hover:border-pink-400 hover:bg-pink-50 dark:border-pink-800/70 dark:text-zinc-300 dark:hover:bg-pink-950/20 sm:inline-flex motion-reduce:transform-none">
